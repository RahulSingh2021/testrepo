...
export const NAVIGATION_ITEMS: NavItem[] = [
  { 
    ...
    label: 'Dashboard',
    subItems: [
      { id: 'dashboard-license', label: 'License Management', allowedScopes: ['super-admin', 'corporate', 'regional', 'unit'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] }
    ],
  ...
  { 
    ...
    subItems: [
      ...
      { id: 'corp-notifications', label: 'Notification Settings', allowedScopes: ['super-admin', 'corporate', 'regional', 'unit'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
  ...
  { 
    ...
    allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'],
    subItems: [
      { id: 'ins-observations', label: 'Observations', allowedScopes: ['corporate', 'regional', 'unit', 'department'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
      { id: 'ins-internal-audit', label: 'Internal Audit', allowedScopes: ['super-admin', 'corporate', 'regional', 'unit', 'department'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
      { id: 'facility', label: 'Facility Hygiene', allowedScopes: ['super-admin', 'corporate', 'regional', 'unit', 'department'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
  ...
  { 
    ...
    subItems: [
      ...
      { id: 'corp-sops', label: 'SOPs', allowedScopes: ['corporate', 'regional', 'unit', 'department', 'user'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
  ...
  },
  {
    ...
    allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'],
    subItems: [
      { id: 'learning-dashboard', label: 'Training Dashboard', allowedScopes: ['super-admin', 'corporate', 'regional', 'unit'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
      ...
      { id: 'learning-certificates', label: 'Certificate Studio', allowedScopes: ['super-admin', 'corporate', 'regional', 'unit'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
      { id: 'learning-student-dashboard', label: 'My Learning', allowedScopes: ['super-admin', 'corporate', 'regional', 'unit', 'department', 'user'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
      { id: 'learning-course-catalog', label: 'Course Catalog', allowedScopes: ['super-admin', 'corporate', 'regional', 'unit', 'department', 'user'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] }
    ]
  },
  {
    id: 'learning-admin',
    label: 'LMS',
    allowedScopes: ['super-admin'],
    allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'],
    allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'],
    subItems: [
      { id: 'ladmin-dashboard', label: 'Training Dashboard', allowedScopes: ['super-admin'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
      { id: 'ladmin-trainer', label: 'Trainer', allowedScopes: ['super-admin'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
      { id: 'ladmin-tni', label: 'TNI', allowedScopes: ['super-admin'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
      { id: 'ladmin-calendar', label: 'Training Calendar', allowedScopes: ['super-admin'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
      { id: 'ladmin-tracker', label: 'Training Tracker', allowedScopes: ['super-admin'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
      { id: 'ladmin-participants', label: 'Participants Database', allowedScopes: ['super-admin'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
      { id: 'ladmin-quiz', label: 'Create Quiz', allowedScopes: ['super-admin'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
      { id: 'academy-dashboard', label: 'Academy Dashboard', allowedScopes: ['super-admin', 'corporate', 'regional', 'unit'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
      { id: 'academy-courses', label: 'Academy Courses', allowedScopes: ['super-admin', 'corporate', 'regional', 'unit'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
      { id: 'academy-categories', label: 'Academy Categories', allowedScopes: ['super-admin', 'corporate', 'regional', 'unit'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
      { id: 'academy-curriculum', label: 'Curriculum Builder', allowedScopes: ['super-admin', 'corporate', 'regional', 'unit'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
      { id: 'academy-quizzes', label: 'Quiz Manager', allowedScopes: ['super-admin', 'corporate', 'regional', 'unit'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
      { id: 'academy-students', label: 'Academy Students', allowedScopes: ['super-admin', 'corporate', 'regional', 'unit'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
      { id: 'academy-badges', label: 'Badges', allowedScopes: ['super-admin', 'corporate', 'regional', 'unit'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
      { id: 'academy-affiliates', label: 'Affiliates', allowedScopes: ['super-admin', 'corporate', 'regional', 'unit'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
      { id: 'academy-whatsapp-inbox', label: 'WhatsApp Inbox', allowedScopes: ['super-admin'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] },
      { id: 'ladmin-promo-blasts', label: 'Promo Blasts', allowedScopes: ['super-admin'], allowedSubscriptions: ['trial', 'basic', 'advance', 'pro'], allowedIndustries: ['catering', 'dairy', 'nutraceutical', 'manufacturing', 'mid-day-meal', 'general'] }
    ]
  },
  {
    id: 'academy-content',
...
export const MOCK_ENTITIES: Entity[] = [
  { 
    ...
    masterRoles: ["HOD", "Executive", "Supervisor", "Associate", "Staff", "Food Safety Team Leader", "Food Safety Team"],
    masterCategories: [
      { name: "Staff", workforce: "core" },
      { name: "Management", workforce: "core" },
      { name: "Trainee", workforce: "extended" },
      { name: "Contractor", workforce: "extended" },
      { name: "Intern", workforce: "extended" },
      { name: "FTC", workforce: "extended" },
    ],
    masterSops: [
      { id: 'sop-1', name: 'Storage Control', subTopics: ['Dry Storage', 'Cold Storage', 'Chemical Storage'] },
      { id: 'sop-2', name: 'Supplier Approval & Receiving Control', subTopics: ['Vendor Evaluation', 'Receiving Inspection', 'Documentation'] },
      { id: 'sop-3', name: 'Food Processing & Handling', subTopics: ['Preparation', 'Cooking', 'Cooling'] },
      { id: 'sop-4', name: 'Temperature Control', subTopics: ['Hot Holding', 'Cold Holding', 'Transport'] },
      { id: 'sop-5', name: 'Cooking Oil Management', subTopics: ['Oil Testing', 'Oil Rotation', 'Disposal'] },
      { id: 'sop-6', name: 'Cleaning, Sanitation & Chemical Control', subTopics: ['Cleaning Schedules', 'Chemical Handling', 'Sanitizer Concentration'] },
      { id: 'sop-7', name: 'Waste Management', subTopics: ['Segregation', 'Disposal', 'Record Keeping'] },
      { id: 'sop-8', name: 'Facility & Infrastructure Control', subTopics: ['Maintenance', 'Pest Proofing', 'Equipment Calibration'] },
      { id: 'sop-9', name: 'Personnel Health & Hygiene', subTopics: ['Hand Washing', 'Illness Reporting', 'Uniform Standards'] },
      { id: 'sop-10', name: 'Service & Distribution', subTopics: ['Buffet Management', 'Room Service', 'Transport'] }
    ],
    masterBrands: []
  },
  // Existing Region
